  ...
  return (
    <div className='px-10 py-3 bg-[#202f4b] rounded-tl-lg flex items-center justify-between'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <Link href={link} className='flex items-center gap-2 bg-[#f7e135] rounded-full py-1 font-semibold px-2 text-[#202f4b] duration-200 hover:bg-black hover:text-white'>
