...
import RiwayatSewaCard from '@/components/template/RiwayatSewaCard'
import SectionHeader from '@/components/template/SectionHeader'
import { RIWAYAT_SEWA, SIDEBAR_LIST } from '@/constant'
    ...
    <>
      ...
      <section className='flex justify-center px-5 pt-8 pb-20 gap-5'>
        ...
        <div className='w-[70%] border rounded-tl-lg rounded-b-lg shadow-lg'>
          {/* Header */}
          <SectionHeader title='Riwayat Sewa' placeholder='Cari ID Sewa' buttonVisibility='hidden' name='sewaID' link='/Market/Vehicle/AddVehicle'/>
          {/* End of Header */}

          <div className='flex flex-col gap-5 p-6'>
            {RIWAYAT_SEWA.map((riwayat) => (
              <RiwayatSewaCard key={riwayat.sewaID} sewaID={riwayat.sewaID} img={riwayat.img} kendaraan={riwayat.kendaraan} tanggalPengajuan={riwayat.tanggalPengajuan} tanggalPengembalian={riwayat.tanggalPengembalian} penyewa={riwayat.penyewa} lamaSewa={riwayat.lamaSewa} />
            ))}
          </div>
        </div>
      </section>
