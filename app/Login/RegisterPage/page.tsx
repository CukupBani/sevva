          ...
          <form className='flex flex-col gap-4 mt-8'>
            ...
            <div className='flex items-center gap-5'>
              <div className='flex flex-col gap-1 w-full'>
                ...
                <input type='text' placeholder='Nama Depan' name='namaDepan' className='bg-[#c9c9c9] bg-opacity-10 rounded-lg px-4 py-3 w-full text-white focus:outline-none' />
              </div>

              <div className='flex flex-col gap-1 w-full'>
                <label htmlFor='namaBelakang' className='text-white text-[14px]'>Nama Belakang</label>
                <input type='text' placeholder='Nama Belakang' name='namaBelakang' className='bg-[#c9c9c9] bg-opacity-10 rounded-lg px-4 py-3 w-full text-white focus:outline-none' />
              </div>
            </div>

            <div className='flex flex-col gap-1'>
              <label htmlFor='email' className='text-white text-[14px]'>Email</label>
              <input type='text' placeholder='Email' name='email' className='bg-[#c9c9c9] bg-opacity-10 rounded-lg px-4 py-3 w-full text-white focus:outline-none' />
            </div>

            <div className='flex flex-col gap-1'>
              <label htmlFor='username' className='text-white text-[14px]'>Username</label>
              <input type='text' placeholder='Username' name='username' className='bg-[#c9c9c9] bg-opacity-10 rounded-lg px-4 py-3 w-full text-white focus:outline-none' />
            </div>

            <div className='flex flex-col gap-1'>
              <label htmlFor='password' className='text-white text-[14px]'>Password</label>
              <input type='password' placeholder='Password' name='password' className='bg-[#c9c9c9] bg-opacity-10 rounded-lg px-4 py-3 w-full text-white focus:outline-none' />
            </div>
